...
Firt we will use the functionality found within the tm package to create a Term Document Matrix. A Term Document Matrix is used to better understand our data and assist us in analyzing the frequency of words. First we will create a Term Document Matrix and use it for unigrams tokenization. 
...
uni_tdm <- (removeSparseTerms(uni_tdm, 0.96))
