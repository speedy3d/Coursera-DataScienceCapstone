...
Firt we will use the functionality found within the tm package to create a Term Document Matrix. A Term Document Matrix is used to better understand our data and assist us in analyzing the frequency of words. 

```{r}
data_tdm <- TermDocumentMatrix(clean_corpus)
```

### Tokenization

Now that we have the Term Document Matrix we can tokenize our data into unigrams and bigrams more easily. 
