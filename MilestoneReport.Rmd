...
First we will need to combine these three files into one clean corpus. We wil use the tm package to assist with the data cleaning and transformation. TO process these data we will do the following:

```{r}
#Merge the three data sets
dataset_complete <- c(dataset_blogs, dataset_news, dataset_twitter)

#Create a clean corpus of all three files
