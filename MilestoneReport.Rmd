...
```{r}
barplot(unigrams[1:20,2], col="blue",
        main="Highest Frequency Unigrams (Top 20)", ylab="Frequency",
        las=2, names.arg = unigrams[1:20,1])
```
...
```{r}
barplot(bigrams[1:20,2], col="dark blue",
        main="Highest Frequency Bigrams (Top 20)", ylab="Frequency", 
        las=2, names.arg = bigrams[1:20,1])
```
...
*Output datasets into files (so that )
