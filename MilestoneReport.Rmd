...
barplot(data_stats$Words, names.arg = c("Blogs File", "News File", "Twitter File"), col="blue",
        main="Number of Words in Each File", ylab="Number of Words", xlab="File Name")
```
...
First we will need to combine these three files into one corpus. We wil use the tm package to assist with the data cleaning and transformation.
