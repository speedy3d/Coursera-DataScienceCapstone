...
```{r}
barplot(unigrams[1:20,2], col="light blue",
        main="Highest Frequency Unigrams", xlab="Word", ylab="Frequency",
        names.arg = unigrams[1:20,1])
```
...
```{r}
barplot(bigrams[1:10,2], col="light green",
        main="Highest Frequency Bigrams", xlab="Word", ylab="Frequency", 
        names.arg = bigrams[1:10,1])
```
